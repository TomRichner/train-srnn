...
GROUPS = [
    ...
    ("Dendritic / fast", [
        ...
        ("cell.log_tau_d_vec",  "C1"),
        ("cell.a_0_scalar",     "C2"),
        ("cell.a_0_vec",        "C3"),
        ("cell.log_tau_global", "C4"),
    ]),
    ("SFA E", [
        ("cell.log_tau_a_E_gain", "C0"),
        ("cell.log_tau_a_E_vec",  "C1"),
        ("cell.log_c_E_gain",     "C2"),
        ("cell.log_c_E_vec",      "C3"),
        ("cell.c_0_E_scalar",     "C4"),
        ("cell.c_0_E_vec",        "C5"),
    ]),
    ("SFA I", [
        ("cell.log_tau_a_I_gain", "C0"),
        ("cell.log_tau_a_I_vec",  "C1"),
        ("cell.log_c_I_gain",     "C2"),
        ("cell.log_c_I_vec",      "C3"),
        ("cell.c_0_I_scalar",     "C4"),
        ("cell.c_0_I_vec",        "C5"),
    ]),
    ("STD E", [
        ("cell.log_tau_b_rec_E_gain", "C0"),
        ("cell.log_tau_b_rec_E_vec",  "C1"),
        ("cell.log_tau_b_rel_E_gain", "C2"),
        ("cell.log_tau_b_rel_E_vec",  "C3"),
    ]),
    ("STD I", [
        ("cell.log_tau_b_rec_I_gain", "C0"),
        ("cell.log_tau_b_rec_I_vec",  "C1"),
        ("cell.log_tau_b_rel_I_gain", "C2"),
        ("cell.log_tau_b_rel_I_vec",  "C3"),
    ]),
]
